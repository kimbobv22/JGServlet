...
import com.jg.service.JGMultipartUploadProgressListener.JGUploadProgressStatus;
...
public class JGMultipartData{
	...
	public Set<String> keySetOfParameters(){
		return _parameters.keySet();
	}
	public Collection<String> valuesOfParameters(){
		return _parameters.values();
	}
	
	protected void setParameter(String key_, String value_){
		_parameters.put(key_, value_);
	}
	public String getParameter(String key_){
